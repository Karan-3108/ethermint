...
SIMAPP = ./app
HTTPS_GIT := https://github.com/Karan-3108/ethermint.git
...
docker-build:
	...
	docker create --name ethermint -t -i Karan-3108/ethermint:latest ethermint
...
PACKAGE_NAME:=github.com/Karan-3108/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/Karan-3108/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/Karan-3108/ethermint/tests/importer
