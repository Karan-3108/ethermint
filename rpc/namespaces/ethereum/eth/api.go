...
import (
	...
	"github.com/Karan-3108/ethermint/ethereum/eip712"
	...
	rpctypes "github.com/Karan-3108/ethermint/rpc/types"
...
func (e *PublicAPI) Resend(ctx context.Context, args evmtypes.TransactionArgs, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error) {
	...
	for _, tx := range pending {
		// FIXME does Resend api possible at all?  https://github.com/Karan-3108/ethermint/issues/905
