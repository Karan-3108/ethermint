...
Learn about Ambinet and its primary features. {synopsis}
...
Ambinet allows for running vanilla Ethereum as a [Cosmos](https://cosmos.network/)
...
Here’s a glance at some of the key features of Ambinet:
...
Ambinet enables these key features by:
...
| Property                     | Value                                                |
|------------------------------|------------------------------------------------------|
| Ambinet Testnet                | `{{ $themeConfig.project.testnet_chain_id }}`        |
| Ambinet Mainnet                | `{{ $themeConfig.project.chain_id }}`                |
