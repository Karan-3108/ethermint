...
1. `fortressd` is the command-line interface client that is used to send transactions and query Ambinet
...
5. `--fees` is a flat-rate incentive for a validator to process your transaction
   ...
   - 7500afortress is equal to 0.0075 AMBINET
6. `--chain-id fortress_90001-2` is Ambinet Mainnet. For current and past chain-id's, please look at the [Karan-3108/mainnet resource](https://github.com/Karan-3108/mainnet)
   - the testnet chain ID is [fortress_9000-4](https://testnet.mintscan.io/fortress). For current and past testnet information, please look at the [testnet repository](https://github.com/Karan-3108/testnets)
7. `--node` is using a full node to send the transaction to the Ambinet Mainnet
