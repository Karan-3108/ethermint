...
{
  "description": "staking, gas and governance token of the Ambinet testnets"
  "denom_units": [
		{
			"denom": "aambinet",
			"exponent": 0,
			"aliases": ["atto ambinet"]
		},
		{
			"denom": "ambinet",
			"exponent": 18
	...
	cmd.Flags().String(cli.FlagDeposit, "1aambinet", "deposit of proposal")
