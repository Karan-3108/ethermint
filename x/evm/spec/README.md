...
The `x/evm` is part of the [ethermint library](https://pkg.go.dev/github.com/Karan-3108/ethermint). For an example of how Ethermint can be used on any Cosmos-SDK chain, please refer to [Fortress](https://www.github.com/Karan-3108/fortress).
