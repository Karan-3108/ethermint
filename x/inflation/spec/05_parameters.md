...
the distribution from the Ambinet Token Model is recalculated into a distribution
that excludes team vesting. Note, that this does not change the inflation
proposed in the Ambinet Token Model. Each `InflationDistribution` can be
