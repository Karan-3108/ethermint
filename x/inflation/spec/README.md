...
The `x/inflation` module mints new Ambinet tokens and allocates them in daily
epochs according to the [Ambinet Token
...
The allocation of new coins incentivizes specific behaviour in the Ambinet
