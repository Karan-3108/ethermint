...
1. Either [open](https://github.com/Karan-3108/ethermint/issues/new/choose) or
   [find](https://github.com/Karan-3108/ethermint/issues) an issue you'd like to help with
...
- Looking for a good place to start contributing? How about checking out some
  [good first issues](https://github.com/Karan-3108/ethermint/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
When proposing an architecture decision for Ethermint, please start by opening an [issue](https://github.com/Karan-3108/ethermint/issues/new/choose) or a [discussion](https://github.com/Karan-3108/ethermint/discussions/new) with a summary of the proposal. Once the proposal has been discussed and there is rough alignment on a high-level approach to the design, the [ADR creation process](https://github.com/Karan-3108/ethermint/blob/main/docs/architecture/PROCESS.md) can begin. We are following this process to ensure all involved parties are in agreement before any party begins coding the proposed implementation. If you would like to see examples of how these are written, please refer to the current [ADRs](https://github.com/Karan-3108/ethermint/tree/main/docs/architecture).
...
`$GOPATH/src/github.com/Karan-3108/ethermint`, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

- Create the fork on GitHub, using the fork button.
- Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/Karan-3108/ethermint`)
...
The main branch of every Karan-3108 repository should just build with `go get`,
...
- create a development branch either on github.com/Karan-3108/ethermint, or your fork (using `git remote add origin`)
...
Subsequently after the meeting, and pending final approval from Karan-3108,
...
- Missing 3 scheduled meetings results in Karan-3108 evaluating whether the member should be
    removed / replaced
...
- Architecture Decision Records (ADRs) may be proposed by any contributors or maintainers of Ethermint,
    ...
    [ADR Creation Process](https://github.com/Karan-3108/ethermint/blob/main/docs/architecture/PROCESS.md)
...
- Core Members: **Federico** (Karan-3108), **Akash** (Karan-3108), **Nick** (Karan-3108)
